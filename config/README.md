...
- These are the minimum required vars need to setup to make Ayiin Music Bot functional.
...
8. `STRING_SESSION` : Pyrogram Session Needed, Generate string from [@AyiinStringRobot](http://t.me/AyiinStringRobot) in Telegram.
...
- You can play tracks or playlists from spotify from Ayiin Music Bot
...
- If you plan to use Ayiin Music Bot with your own customized or modified code.
...
- You can change images which are used in Ayiin Music Bot.
...
1. `STRING_SESSION2` : Pyrogram Session Needed, Generate string from [@AyiinStringRobot](http://t.me/AyiinStringRobot) in Telegram.
2. `STRING_SESSION3` : Pyrogram Session Needed, Generate string from [@AyiinStringRobot](http://t.me/AyiinStringRobot) in Telegram.
3. `STRING_SESSION4` : Pyrogram Session Needed, Generate string from [@AyiinStringRobot](http://t.me/AyiinStringRobot) in Telegram.
4. `STRING_SESSION5` : Pyrogram Session Needed, Generate string from [@AyiinStringRobot](http://t.me/AyiinStringRobot) in Telegram.
